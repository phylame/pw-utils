...
public class PagingResultSet {
    ...
    public PagingResultSet(DbHelper dbHelper, String sql, int pageSize,
                           int resultSetType,
    ...
    public void refresh() throws SQLException {
        ...
        Statement stmt = dbHelper.getConnection().createStatement(resultSetType,
        ...
        if (pageCount > 0) {
            // data has been deleted in other way, move to last page
