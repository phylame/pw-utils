...
public class DbHelper {
    ...
    private void connect() throws SQLException {
        ...
        conn = DriverManager.getConnection(profile.getURL(), profile.getUserName(),
                profile.getPassword());
    }
     ...
     * @param resultSetType a result set type, see {@link ResultSet}
     * @param resultSetConcurrency a concurrency type, see {@link ResultSet}
     * @return number of updated rows
     * @throws SQLException if occur errors when querying
     */
    public int executeUpdate(String sql, int resultSetType, int resultSetConcurrency)
            throws SQLException {
        checkConnection();
    ...
    public int executeUpdate(String sql) throws SQLException {
        return executeUpdate(sql, ResultSet.TYPE_FORWARD_ONLY,
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        return executeQuery(sql, ResultSet.TYPE_FORWARD_ONLY,
                ResultSet.CONCUR_READ_ONLY);
    }
     ...
     */
    public PagingResultSet queryAndPaging(String sql,
                                          int pageSize,
                                          int resultSetType,
                                          int resultSetConcurrency) throws SQLException {
        checkConnection();
        return new PagingResultSet(this, sql, pageSize, resultSetType,
     ...
     * @throws SQLException if occur errors when querying or paging
     */
    public PagingResultSet queryAndPaging(String sql, int pageSize)
            throws SQLException {
